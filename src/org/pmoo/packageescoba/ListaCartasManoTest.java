...
public class ListaCartasManoTest {
    ...
    public void testObtenerCartaDevuelveLaCartaCorrectaSinEliminarla() {
        ...
        Carta obtenida = mano.obtenerCarta(0);
        
        assertEquals(carta, obtenida);
        assertEquals(1, mano.tamaño());
    }

    @Test
    public void testElegirCartaDevuelveYExtraeLaCartaCorrecta() {
        ListaCartasMano mano = new ListaCartasMano();
        ...
        assertEquals(1, mano.tamaño());
        assertEquals(carta2, mano.obtenerCarta(0));
    }
