...
public class IndiceCombinacionInvalidoException extends Exception {
    ...
    /**
     * Constructora que detalla el índice erroneo y la cantidad máxima de combinaciones disponibles.
     * 
    ...
    public IndiceCombinacionInvalidoException(int indice, int maximo) {
        super("Indice de combinación inválido: " + indice + " (debe estar entre 1 y " + maximo + ")");
    }
}
